...
> ✅ **编译状态：CI 构建成功（最近一次：2026-08-09）**
>
> - **LSPosed 版本**：APK 已签名，可安装测试（见下方安装说明）
> - **Zygisk 版本**：模块包已构建，但注入后曾出现微信卡启动问题，**请优先使用 LSPosed 模式**
...
|------|------|
| 屏蔽铃声 | 屏蔽音视频通话的呼出/呼入铃声 |
| 虚拟视频通话 | 在微信视频通话相机预览中播放本地视频或网络直播流 |
...
| 功能 | 说明 |
|------|------|
| 显示微信 ID | 在联系人与群组详情页面显示微信 ID（点击复制） |
...
> ⚠️ **此方式曾存在微信卡启动问题（Zygisk 注入路线），如需测试请先备份微信数据。**
