...
import com.github.welite.ui.utils.theme.SeedResolver.customSeed

/**
 * Single source of truth for turning [ThemeSettings] into a concrete accent seed and the derived
 * Material 3 / miuix color schemes. Shared by [ModuleTheme] and [com.github.welite.ui.utils.InjectedUiTheme]
 * so the module UI and the WeKite UI injected into WeChat agree on the same colors.
 */
object SeedResolver {
