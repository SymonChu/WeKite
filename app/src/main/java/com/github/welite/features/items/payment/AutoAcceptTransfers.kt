...
import com.github.welite.features.api.core.WeDatabaseListenerApi
import com.github.welite.features.api.core.WeMessageApi
import com.github.welite.features.api.core.WePaymentApi
            ...
            try {
                ...
                if (rules.autoReply.enabled) {
                    WeMessageApi.sendText(
                        msgInfo.talker,
                        rules.autoReply.text.replace(transferMsg.feedesc, transferMsg.feedesc)
                    )
                }
