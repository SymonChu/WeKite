 ...
 *
 * `com.github.wekite.agent.trigger.TriggerScheduler` sleeps in-process on purpose (its triggers are
...
internal object HideContactsSchedule {
     ...
     */
    private const val ACTION_FIRE = "com.github.wekite.action.HIDE_CONTACTS_SCHEDULE"
