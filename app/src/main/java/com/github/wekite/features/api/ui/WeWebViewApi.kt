...
import com.github.wekite.features.api.ui.WeWebViewApi.evaluateJavascript
import com.github.wekite.features.api.ui.WeWebViewApi.loadUrl
import com.github.wekite.features.api.ui.WeWebViewApi.reload
import com.github.wekite.features.api.ui.WeWebViewApi.tracked
 ...
 * 方法名调用，同时适配二者（与 [com.github.wekite.features.items.miniapps.ErudaConsole] 的做法一致）。
 */
@Feature(
    name = "WebView 追踪服务",
    categories = ["API"],
