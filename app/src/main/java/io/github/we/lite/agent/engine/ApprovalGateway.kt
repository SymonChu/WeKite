...
import io.github.we.lite.agent.model.LlmRequest
...
class ApprovalGateway(
    ...
    private fun parseDecision(text: String): ApprovalDecision {
        ...
        val obj = runCatching {
            io.github.we.lite.agent.model.LlmJson.json.parseToJsonElement(body).jsonObject
        }.getOrElse {
...
data class SmallModelRef(
    val client: io.github.we.lite.agent.model.LlmClient,
