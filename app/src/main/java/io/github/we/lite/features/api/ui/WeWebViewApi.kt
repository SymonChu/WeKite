...
import io.github.we.lite.features.api.ui.WeWebViewApi.evaluateJavascript
import io.github.we.lite.features.api.ui.WeWebViewApi.loadUrl
import io.github.we.lite.features.api.ui.WeWebViewApi.reload
import io.github.we.lite.features.api.ui.WeWebViewApi.tracked
 ...
 * 方法名调用，同时适配二者（与 [io.github.we.lite.features.items.miniapps.ErudaConsole] 的做法一致）。
 */
@Feature(
    name = "WebView 追踪服务",
    categories = ["API"],
