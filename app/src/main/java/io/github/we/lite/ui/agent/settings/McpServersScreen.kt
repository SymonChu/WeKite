package io.github.we.lite.ui.agent.settings
...
import io.github.we.lite.agent.data.WeAgentRepository
import io.github.we.lite.agent.data.entity.McpTransport
import io.github.we.lite.agent.data.entity.ProviderEntity
import io.github.we.lite.agent.mcp.McpClientManager
import io.github.we.lite.agent.mcp.McpProviderStatus
import io.github.we.lite.agent.mcp.McpToolProvider
...
private val MCP_MODE_ORDER = listOf(
    io.github.we.lite.agent.tool.ToolMode.ENABLED,
    io.github.we.lite.agent.tool.ToolMode.MANUAL_APPROVAL,
    io.github.we.lite.agent.tool.ToolMode.SMART_APPROVAL,
    io.github.we.lite.agent.tool.ToolMode.DISABLED,
)

private fun io.github.we.lite.agent.tool.ToolMode.mcpLabel(): String = when (this) {
    io.github.we.lite.agent.tool.ToolMode.ENABLED -> "直接允许"
    io.github.we.lite.agent.tool.ToolMode.MANUAL_APPROVAL -> "手动审批"
    io.github.we.lite.agent.tool.ToolMode.SMART_APPROVAL -> "智能审批"
    io.github.we.lite.agent.tool.ToolMode.DISABLED -> "禁用"
}

@Composable
private fun McpToolModeDropdown(name: String, mode: io.github.we.lite.agent.tool.ToolMode, onChange: (io.github.we.lite.agent.tool.ToolMode) -> Unit) {
