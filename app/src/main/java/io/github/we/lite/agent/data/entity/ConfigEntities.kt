package io.github.we.lite.agent.data.entity
 ...
 * [io.github.we.lite.agent.data.WeAgentRepository.upsertModelProvider] for why.
 */
...
data class ModelEntity(
     ...
     * into [io.github.we.lite.agent.tool.ToolVisibility.visionTools], so concurrent sessions on
 ...
 * Keys are stored as-is; see [io.github.we.lite.agent.net.ExternalServiceId] for known ids.
 */
