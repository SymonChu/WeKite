...
/**
 * API-agnostic conversation types consumed by the [io.github.we.lite.agent.engine] loop. The
 ...
 * [io.github.we.lite.agent.engine.AgentSessionEngine.runTurn] tool loop and is **not** persisted —
