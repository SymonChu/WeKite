...
import io.github.we.lite.activity.agent.AgentSettingsScreen
import io.github.we.lite.agent.data.OverlayMode
import io.github.we.lite.agent.data.WeAgentRepository
import io.github.we.lite.agent.data.WeAgentSettings
import io.github.we.lite.agent.data.entity.ModelEntity
import io.github.we.lite.features.api.agent.WeAgentService
import io.github.we.lite.features.items.system.agent.WeAgentOverlayController
...
fun WeAgentHomeScreen(onOpen: (AgentSettingsScreen) -> Unit) {
    ...
    LaunchedEffect(Unit) {
        dynamicTools = WeAgentSettings.toolLoadingMode() == io.github.we.lite.agent.tool.ToolLoadingMode.DYNAMIC
