package io.github.we.lite.agent.trigger
 ...
 *
 * These enums are stored by Room (by name, via [io.github.we.lite.agent.data.WeAgentConverters]) and
...
data class TriggerConditions(
    ...
    /** Allowed message `type` codes (see [io.github.we.lite.features.api.core.models.MessageType]); null/empty = any. */
