package io.github.we.lite.activity.agent
...
import io.github.we.lite.features.api.agent.WeAgentService
import io.github.we.lite.ui.agent.settings.BuiltinProvidersScreen
import io.github.we.lite.ui.agent.settings.ExternalServicesScreen
import io.github.we.lite.ui.agent.settings.McpServerDetailScreen
import io.github.we.lite.ui.agent.settings.McpServersScreen
import io.github.we.lite.ui.agent.settings.MemoryScreen
import io.github.we.lite.ui.agent.settings.ModelProviderDetailScreen
import io.github.we.lite.ui.agent.settings.ModelProvidersScreen
import io.github.we.lite.ui.agent.settings.PromptsScreen
import io.github.we.lite.ui.agent.settings.SkillsScreen
import io.github.we.lite.ui.agent.settings.ToolPermissionListScreen
import io.github.we.lite.ui.agent.settings.TriggersScreen
import io.github.we.lite.ui.agent.settings.WeAgentHomeScreen
import io.github.we.lite.ui.agent.settings.WorkspacesScreen
import io.github.we.lite.ui.agent.settings.builtinProviderTools
import io.github.we.lite.ui.content.MiuixStackNavigator
import io.github.we.lite.ui.utils.theme.ModuleTheme
 ...
 *
 * Navigation mirrors [io.github.we.lite.activity.settings.SettingsActivity]: a stack of screens
 ...
 *
 * Named `*SettingsActivity` so [io.github.we.lite.loader.utils.ActivityProxy] routes it through the
