package io.github.we.lite.agent.jvm
 ...
 * argument is a self-describing `kind:payload` **token** (see [io.github.we.lite.agent.jvm.JvmValueBridge.parseValue]); every result is
 * rendered back either inline (primitives/strings/null) or as a freshly-minted handle
 * (see [io.github.we.lite.agent.jvm.JvmValueBridge.render]).
 *
