package io.github.we.lite.agent.ui

import io.github.we.lite.agent.model.LlmImage
 ...
 *
 * Installed by [io.github.we.lite.features.api.agent.WeAgentService] around
 * [io.github.we.lite.agent.engine.AgentSessionEngine.runTurn], mirroring
 * [io.github.we.lite.agent.workspace.VfsContext]. Screenshots are intentionally NOT persisted to
