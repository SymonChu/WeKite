package io.github.we.lite.dexkit.abc
 ...
 *
 * 实现类通过 [io.github.we.lite.dexkit.dsl.dexClass] / [io.github.we.lite.dexkit.dsl.dexMethod] / [io.github.we.lite.dexkit.dsl.dexConstructor] 工厂函数声明委托属性，
...
interface IResolveDex {
     ...
     * 供 [io.github.we.lite.dexkit.cache.DexCacheManager] 持久化。
     */
