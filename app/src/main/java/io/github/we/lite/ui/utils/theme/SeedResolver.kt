...
import io.github.we.lite.ui.utils.theme.SeedResolver.customSeed

/**
 * Single source of truth for turning [ThemeSettings] into a concrete accent seed and the derived
 * Material 3 / miuix color schemes. Shared by [ModuleTheme] and [io.github.we.lite.ui.utils.InjectedUiTheme]
