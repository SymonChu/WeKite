...
import io.github.we.lite.agent.data.WeAgentSettings.load
...
object WeAgentSettings {
    ...
    suspend fun sendWhileRunningMode(): io.github.we.lite.features.api.agent.WeAgentService.SendWhileRunningMode =
        when (get(KEY_SEND_WHILE_RUNNING)) {
            "QUEUE_AS_STEER" -> io.github.we.lite.features.api.agent.WeAgentService.SendWhileRunningMode.QUEUE_AS_STEER
            else -> io.github.we.lite.features.api.agent.WeAgentService.SendWhileRunningMode.QUEUE_AFTER_TURN
        }
}
