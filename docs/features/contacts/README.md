...
联系人与群组功能提供了联系人管理、群组信息增强等能力。

## 功能列表

- [检测单向删除好友](detect-deleted-friends.md) — 批量扫描全部好友, 检测是否被对方单向删除
- [显示群成员消息历史](display-group-member-messages.md) — 在联系人详情页添加入口, 查看任意群成员的全部历史消息
- [显示微信 ID](show-wx-id-in-contact-details.md) — 在联系人与群组详情页显示微信号
- [隐藏联系人](hide-contacts.md) — 隐藏指定联系人, 可屏蔽对话列表、通讯录、搜索、锁屏等位置
