...
/**
 * Marks a function as a WeAgent built-in tool. The [com.github.wekite.features.AgentToolScanner] KSP processor
 ...
 * so no hand-written mapping table is needed and new [com.github.wekite] APIs are picked up
