...
/**
 * Marks a function as a WeAgent built-in tool. The [com.github.welite.features.AgentToolScanner] KSP processor
 ...
 * so no hand-written mapping table is needed and new [com.github.welite] APIs are picked up
