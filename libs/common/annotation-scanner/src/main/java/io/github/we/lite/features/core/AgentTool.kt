...
/**
 * Marks a function as a WeAgent built-in tool. The [io.github.we.lite.features.AgentToolScanner] KSP processor
 ...
 * so no hand-written mapping table is needed and new [io.github.we.lite] APIs are picked up
